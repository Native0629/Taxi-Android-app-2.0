...
//import com.google.maps.android.ui.IconGenerator.java;
                ...
                public void onClick(View v) {
                    if (CheckConnection.haveNetworkConnection(getActivity())) {
                        if (pickup_location.getText().toString().trim().equals("")) {
                            ...
                            drop_location.setText("Toluca de Lerdo, Méx., México");
...
// Start the autocomplete intent.
    ...
    NearbyData main = new NearbyData();
    String info_vehicle = "";
            ...
            for (NearbyData location : list) {
                ...
                try {
                    ...
                    longitude = Double.valueOf(location.getLongitude());
                                ...
                                double dis = CalculationByDistance(new LatLng(latitude,longitude) ,new LatLng(currentLatitude, currentLongitude));
                    ...
                    if (dis < 0.5) {
                        ...
                        if(selectDriver != null){
                            if(dis < selectDriver) {
                                ...
                                title1 = location.getName();
                                info = location.getVehicle_info();
                                main = location;
                                info_vehicle = location.getVehicle_info();
                                String distance = Double.toString(selectDriver);
                        ...
                        Marker marker = myMap.addMarker(new MarkerOptions()
                                ...
                                .snippet(location.getVehicle_info()).icon(BitmapDescriptorFactory.defaultMarker(BitmapDescriptorFactory.HUE_RED)));
//                        Marker marker2 = myMap.addMarker(new MarkerOptions()
//                                .position(new LatLng(currentLatitude, currentLongitude))
//                                .title(location.getName())
//                                .snippet(location.getVehicle_info()).icon(BitmapDescriptorFactory.defaultMarker(BitmapDescriptorFactory.HUE_BLUE)));
            ...
            Marker marker = myMap.addMarker(new MarkerOptions()
                    ...
                    .title(title1)
                    .snippet(info).icon(BitmapDescriptorFactory.defaultMarker(BitmapDescriptorFactory.HUE_GREEN)));
            marker.setTag(main);



            LatLng noidaPioint = new LatLng(Slatitude, Slongitude);
//        final Marker noidaMarker= myMap.addMarker(new
//                MarkerOptions().position(noidaPioint));
...
////        LatLng latLng = marker.getPosition();
        ...
        title.setText(name);
        String info1 = marker.getSnippet();
        t1.setText(info1);
        ...
        if (nearbyData != null) {
//            Toast.makeText(getActivity(), "dddddddddddddddddddd" , Toast.LENGTH_LONG).show();
            pass.setVehicleName(nearbyData.getVehicle_info());
            txt_info.setText(info_vehicle);
            txt_address.setText("");
...
//            Toast.makeText(getActivity(), "dddddddddddddddddddd" , Toast.LENGTH_LONG).show();
        ...
        txt_address.setText(getAdd(Slatitude, Slongitude) + " ");
...
//    public  Marker function selectCar(List<NearbyData> list){
//
//
////        final Marker MyDriver = null;
//        if (list != null) {
//            for (NearbyData location : list) {
//                Double latitude = null;
//                Double longitude = null;
...
//
//                    double dis = CalculationByDistance(new LatLng(latitude,longitude) ,new LatLng(currentLatitude, currentLongitude));
//                    String distance = Double.toString(dis);
//                    Toast.makeText(getActivity(), distance , Toast.LENGTH_LONG).show();
//
//
//
...
//    }
    ...
    public void onMapReady(GoogleMap googleMap) {
        myMap = googleMap;
//            if(Slatitude == null) Toast.makeText(getActivity(), "ddddddddddddddddddddddd" , Toast.LENGTH_LONG).show();
...
//        View v = getActivity().getLayoutInflater().inflate(R.layout.view_custom_marker, null);
//
//        LatLng latLng = noidaMarker.getPosition();
//        TextView title = (TextView) v.findViewById(R.id.t);
//        TextView t1 = (TextView) v.findViewById(R.id.t1);
//        TextView t2 = (TextView) v.findViewById(R.id.t2);
//        ImageView imageView = (ImageView) v.findViewById(R.id.profile_image);
...
//        t1.setTypeface(font);
//        t2.setTypeface(font);
//        String name = noidaMarker.getTitle();
//        title.setText(name);
//        String info = noidaMarker.getSnippet();
//        t1.setText(info);
//
//        NearbyData nearbyData = (NearbyData) noidaMarker.getTag();
//        if (nearbyData != null) {
//            pass.setVehicleName(nearbyData.getVehicle_info());
//            txt_info.setText(nearbyData.getVehicle_info());
//            txt_address.setText("");
//            driver_id = nearbyData.getUser_id();
//            drivername = noidaMarker.getTitle();
//            t2.setVisibility(View.VISIBLE);
//        } else {
//            t2.setVisibility(View.GONE);
//        }
...
//        noidaMarker.setIcon(BitmapDescriptorFactory.fromBitmap(iconFactory.makeIcon("Noida")));
